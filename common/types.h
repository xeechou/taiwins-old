...
/* first define this shit, you need to make your code as c as possible */
#ifndef TW_EXTERNC
#define TW_EXTERNC extern "C"
#endif
...
//no implementation yet, and you probably should use it here
...
#define tw_list_find(pos, head, member, dmember, value)		\
	({							\
	tw_list *list_node = NULL;			        \
	tw_list_for_each(pos, head, member)			\
		if (value == pos->dmember) {			\
			list_node = &pos->member;		\
			break;					\
		}						\
	list_node;})
