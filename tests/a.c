...
# 2 "test_c.c" 2
# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include/stdbool.h" 1 3 4
# 3 "test_c.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include/stddef.h" 1 3 4
# 328 "/usr/lib/gcc/x86_64-pc-linux-gnu/6.2.1/include/stddef.h" 3 4
typedef int wchar_t;
...
int main(void)
{
 tw_darray darr;
 tw_darray_init(&darr);
 ({ size_t _real_loc = ((&darr)->header + 3) % (&darr)->alloc; const int *_mptr = (int *)(&darr)->data; _mptr[_real_loc]; });
}
